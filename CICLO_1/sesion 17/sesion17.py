...
# def actividad1(numero):
#     diccionario = { 1 : 'I', 2:'II', 3:'III', 4:'IV', 5:'V', 6:'VI', 7:'VII', 8:'VIII', 9:'IX', 10:'X'}
#     return diccionario[numero]

# n = int(input("Ingrese un número de 1 a 10: "))
# print(f"Su igual en números romanos es {actividad1(n)}")

def caja():
    with open('D:/00_CURSOS/MINTIC/PROGRAMACION_BASICA/EJERCICIOS_MINTIC_2022/CICLO_1/sesion 17/recibo.txt', 'a', encoding='utf-8') as file:
        while True:
            nombre = input("Escriba nombre del producto. Para finalizar N: ")
            precio = input("Precio del producto: ")
            if nombre == 'N':
                break
            else:
                guardaProducto(nombre, precio, file)
    file.close()

def guardaProducto(n,p,a):
    a.writelines(n +',' + p + '\n')
